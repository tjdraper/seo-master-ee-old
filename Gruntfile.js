module.exports = function(grunt) {
	...
	var addOnDir = projectFile.addOnDir;
	var themesDir = projectFile.themesDir;
	var cssDir = projectFile.cssDir;
	var jsDir = projectFile.jsDir;
	var cssFile = projectFile.cssFile;
	var jsFile = projectFile.jsFile;
	var conf = {
		addOnDir: addOnDir,
		themesDir: themesDir,
		cssDir: cssDir,
		...
		bsFiles: {
			src: [
				themesDir + '/' + cssDir + '/' + cssFile,
				themesDir + '/' + jsDir + '/' + jsFile
			]
		},
		bsOptions: {
			watchTask: true,
	...
	conf.lessFiles[themesDir + '/' + cssDir + '/' + cssFile] = [
	...
	if (projectFile.lessBuild.length) {
		projectFile.lessBuild.forEach(function(i) {
			conf.lessFiles[themesDir + '/' + cssDir + '/' + cssFile].push(
				'source/css/' + i
			);
		});
	}
	...
	if (Object.keys(projectFile.jsFiles).length) {
		for (var key in projectFile.jsFiles) {
			conf.jsFiles[themesDir + '/' + jsDir + '/' + key] =
